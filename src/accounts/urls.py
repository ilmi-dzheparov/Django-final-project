...
from .views import (CustomRegistrationView, PasswordView, PersonalAccountView,
                    ProfileView, UserHistoryOrderView, UserHistoryProductView,
                    UserLogoutView, login_view, send_password_reset_email_view)
